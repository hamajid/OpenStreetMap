...
expected = ["Street", "Avenue", "Boulevard", "Drive", "Court", "Place", "Square", "Road", 
            "Parkway", "Plaza", "Broadway", "Circle", "Driveway", "Highway", "Park", "Lane", "Terrace"]

# Fix the unexpected street types to the expected list
mapping = {"St": "Street",
           "st": "Street",
           "Street.": "Street", 
           "street": "Street",
...
def audit_street_type(street_types, street_name):
    ''' collecting and stoting the last words in the "street_name" '''
...
def update_postcode(postcode):
    ...
    if re.findall(r'^\d{5}$', postcode): 
        ...
        return valid_postcode
    elif re.findall(r'MA\s*\d{5}', postcode): 
